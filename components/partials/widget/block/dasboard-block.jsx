    ...
    <>
      <div className="grid md:grid-cols-3 grid-cols-1 gap-4 h-full">
        ...
        {userData.map((item, i) => (
          <Card
            key={i}
            bodyClass={`pt-4 pb-3 px-4 flex  items-center h-full bg-gradient-to-r from-[#054fb9] to-[#0461cf] relative`} 
          >
            <div className="flex space-x-3 rtl:space-x-reverse w-full h-full items-center ">
              <div className="flex-none h-full items-center flex mr-5">
                <div
                  className={` h-[70px] w-[70px] rounded-md  flex flex-col items-center justify-center bg-white border text-3xl text-[#054fb9] `}
                >
