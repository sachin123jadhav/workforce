...
import { getOutstationData, getoutstationSelector } from "@/store/outstation";
...
const Outstation = () => {
    ...
    const outstationSelector = useSelector(getoutstationSelector);

    useEffect(() => {

        dispatch(getOutstationData(token, setLoader));
    ...
    useEffect(() => {
        if (outstationSelector) {
            setoutstationData(outstationSelector);
        }
    }, [outstationSelector]);

    console.log(outstationData)
