...
export const getAssignquicklinksData = (token,setLoader) => async (dispatch) => {
  const localHeader = {
...
//clear all Quicklinks store
export const clearAllQuicklinksStore = () => async (dispatch) => {
...
export const assingquicklinkSelector = (state) => state.allquicklinks.assignquicklinksData;
